...
void vendor_load_properties() {
    ...
    // Extremely optimized ram management.
    if (sys.totalram > 5072ull * 1024 * 1024) {
        // Optimized for devices with more than 5072MB RAM (approx. 6GB or more)
        heapstartsize = "16m";
        ...
        // Optimized for devices with more than 3072MB RAM (approx. 4GB)
        heapstartsize = "12m";
        heapgrowthlimit = "224m";
        heapsize = "512m";
        heaptargetutilization = "0.55";
        heapminfree = "6m";
        heapmaxfree = "24m";
    } else {
        // Optimized for devices with 3072MB RAM or less (approx. 3GB or less)
        heapstartsize = "8m";
